  ...
  return (
      ...
      <div className="detail">
        ...
        <div className="features">
          ...
          <li>
            <strong>Average Goals Query Result:</strong> Dive into the numbers
            with our average goals query result feature. Uncover insights as you
            explore teams and their respective columns, calculating average
            "Goals For" for a given year.
          </li>
        </ol>
        </div>
      </div>
